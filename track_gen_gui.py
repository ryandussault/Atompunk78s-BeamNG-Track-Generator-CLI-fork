...
def main():
    ...
    layout = [[PySimpleGUI.Text("Track Length: "), PySimpleGUI.Slider(range=(1,2000), default_value=1000, key="track_length_slider", enable_events=True, orientation="horizontal")],
              ...
              [PySimpleGUI.Text("Preset (Other params have no effect when a preset is selected): "), PySimpleGUI.DropDown(values=["", "highway", "rally", "normal", "bumpy", "hillclimb", "racetrack"], default_value="", key="preset_dropdown", enable_events=True)],
